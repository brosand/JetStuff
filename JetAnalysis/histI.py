...
if (args.type==''):
    args.type=raw_input('Enter type: ')
...
histProb1=ROOT.TH1F('histProb1', 'Probability Distribution of Guess ' +str(args.type[:1] + ' for true sample in ' +str(args.type) ), 20, 0, 1)
histProb2=ROOT.TH1F('histProb2', 'Probability Distribution of Guess ' +str(args.type[1:2] + ' for true sample in ' +str(args.type) ), 20, 0, 1)
...
if (args.draw==0 or args.draw==2):
    ...
    canvasCoef.SaveAs(folder+str(args.validation_size) + "/r" +str(args.range)+ '/' +str(args.notes) + title + "_" + str(dimension) + ".pdf")
    ...
    canvasCoefLog.SaveAs(folder+str(args.validation_size) + "/r" +str(args.range)+"/"+str(args.notes) + title + "_" + str(dimension) + "_NNCoefLog.pdf")
