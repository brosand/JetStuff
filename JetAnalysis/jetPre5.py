...
def readTree(filename1, filename2):
    ...
    tReader = ROOT.TTreeReader("tree", fIn)
    jReader = ROOT.TTreeReader("jetTree", fIn2)
    myNParticles = ROOT.TTreeReaderValue(int)(tReader, "nFinalParticles") 
    myNJets = ROOT.TTreeReaderValue("int")(jReader, "nJets") 
class 
    ...
    while jReader.Next() and tReader.Next():
        print(myNJets)
        print(myNJets)
        print(myNParticles)
