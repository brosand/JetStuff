...
python NNJet.py 2 aJetPre.txt bJetPre.txt nEpochs 5 inputDim 5 numClasses 2 nNodes 100 nLayers 5
echo "DNN ac done"
python NNJet.py 2 aJetPre.txt cJetPre.txt nEpochs 5 inputDim 5 numClasses 2 nNodes 100 nLayers 5
echo "DNN ac done"
python NNJet.py 2 aJetPre.txt dJetPre.txt nEpochs 5 inputDim 5 numClasses 2 nNodes 100 nLayers 5
echo "DNN ad done"
python NNJet.py 2 bJetPre.txt cJetPre.txt nEpochs 5 inputDim 5 numClasses 2 nNodes 100 nLayers 5
echo "DNN bc done"
python NNJet.py 2 bJetPre.txt dJetPre.txt nEpochs 5 inputDim 5 numClasses 2 nNodes 100 nLayers 5
echo "DNN bd done"
python NNJet.py 2 cJetPre.txt dJetPre.txt nEpochs 5 inputDim 5 numClasses 2 nNodes 100 nLayers 5
echo "DNN cd done"
